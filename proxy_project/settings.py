...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-proxy-secret-key-change-in-production')
...
POLYGON_API_KEY = os.environ.get('POLYGON_API_KEY', 'wLTZ8DMQ1tGnrlBQtkzcz8r6V6MadT6w')
...
MICROSERVICE_WS_URL = os.environ.get('MICROSERVICE_WS_URL', 'ws://localhost:8001/ws/stocks/')
