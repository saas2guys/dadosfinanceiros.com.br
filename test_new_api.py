...
class FinancialAPITester:
    ...
    def test_reference_endpoints(self):
        ...
        reference_tests = [
            {
                'name': 'Market Status',
                'endpoint': '/api/v1/reference/market-status',
                'provider': 'polygon'
            },
            {
                'name': 'Stock Profile',
                'endpoint': '/api/v1/reference/ticker/AAPL',
                'provider': 'fmp'
            },
            {
                'name': 'Exchanges List',
                'endpoint': '/api/v1/reference/exchanges',
                'provider': 'fmp'
            }
        ]
    ...
    def test_market_data_endpoints(self):
        ...
        market_tests = [
            ...
            {
                'name': 'Market Gainers',
                'endpoint': '/api/v1/quotes/gainers',
                'provider': 'fmp'
            },
            {
                'name': 'Market Losers',
                'endpoint': '/api/v1/quotes/losers',
                'provider': 'fmp'
            },
            {
        ...
        polygon_tests = [
            {
                ...
                'endpoint': '/api/v1/options/contracts',
                'provider': 'polygon'
            },
            {
                'name': 'Options Chain',
                'endpoint': '/api/v1/options/chain/AAPL',
                'provider': 'polygon'
            },
            {
                'name': 'Futures Contracts',
                'endpoint': '/api/v1/futures/contracts',
                'provider': 'polygon'
            }
        ]
        ...
        fmp_tests = [
            {
                ...
                'endpoint': '/api/v1/fundamentals/AAPL/income-statement',
                'provider': 'fmp'
            },
            {
                'name': 'Financial Ratios',
                'endpoint': '/api/v1/fundamentals/AAPL/ratios',
                'provider': 'fmp'
            },
            {
                'name': 'News',
                'endpoint': '/api/v1/news/AAPL',
                'provider': 'fmp'
            },
            {
                'name': 'Analyst Estimates',
                'endpoint': '/api/v1/analysts/AAPL/estimates',
                'provider': 'fmp'
            }
        ]
