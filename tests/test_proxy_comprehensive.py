...
from users.models import User, TokenHistory, Plan
...
class PolygonStocksApiComprehensiveTest(PolygonProxyTestCaseBase):
    ...
    def test_tickers_list_endpoint(self, mock_request):
        ...
        expected_next_url = "https://api.dadosfinanceiros.com.br/v1/reference/tickers?cursor=next123"
...
class PolygonCryptoApiComprehensiveTest(PolygonProxyTestCaseBase):
    ...
    def test_crypto_aggregates_endpoint(self, mock_request):
        ...
        request = self._create_authenticated_request('GET', 'aggs/ticker/X:BTCUSD/range/1/day/2023-01-01/2023-01-31', use_jwt=False)
...
class PolygonForexApiComprehensiveTest(PolygonProxyTestCaseBase):
    ...
    def test_forex_aggregates_endpoint(self, mock_request):
        ...
        request = self._create_authenticated_request('GET', 'aggs/ticker/C:EURUSD/range/1/day/2023-01-01/2023-01-31', use_jwt=False)
