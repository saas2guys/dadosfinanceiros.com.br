...
from .config import (
    ENDPOINT_ROUTES, CACHE_TTL, FMP_API_KEY, POLYGON_API_KEY,
    FinancialAPIError, ProviderError, EndpointNotFoundError
)
...
class FinancialDataProxy:
    ...
    def __init__(self):
        ...
        self.providers = {
            'polygon': get_provider('polygon', POLYGON_API_KEY),
            'fmp': get_provider('fmp', FMP_API_KEY)
        }
