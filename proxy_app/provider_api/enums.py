...
class EndpointFrom(Enum):
    ...
    EARNINGS_CALENDAR = "/earnings/{symbol}/calendar/"
    EARNINGS_HISTORY = "/earnings/{symbol}/history/"
    EARNINGS_SURPRISES = "/earnings/{symbol}/surprises/"
    EARNINGS_TRANSCRIPTS = "/earnings/{symbol}/transcripts/"
    ...
    ETF_HOLDINGS = "/etf/{symbol}/holdings/"
    ETF_LIST = "/etf/list/"
    ETF_PERFORMANCE = "/etf/{symbol}/performance/"
    EXEC_COMP = "/corporate/executive-compensation/"
    EXEC_COMP_BENCHMARK = "/corporate/executive-compensation/benchmark/"
    EXCHANGE_VARIANTS = "/reference/exchange-variants/"
    ...
    FUNDAMENTALS_ENTERPRISE_VALUE = "/fundamentals/{symbol}/enterprise-value/"
    ...
    REFERENCE_TICKERS = "/reference/tickers/"
    SEARCH_CIK = "/reference/search/cik/"
    SEARCH_CUSIP = "/reference/search/cusip/"
    SEARCH_ISIN = "/reference/search/isin/"
    SEC_10K = "/sec/{symbol}/10k/"
    SEC_10Q = "/sec/{symbol}/10q/"
    SEC_8K = "/sec/{symbol}/8k/"
    ...
    SYMBOL_CHANGE = "/reference/symbol-change/"
