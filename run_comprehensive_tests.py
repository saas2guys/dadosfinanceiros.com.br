    ...
    def __init__(self, base_url: str = "http://localhost:8000"):
        ...
        self.test_categories = {
            ...
            'Earnings Data': [
                ...
                'test_earnings_transcripts',
                'test_earnings_history',
                'test_earnings_surprises'
            ],
            'Corporate Events': [
                'test_events_ipo_calendar',
                'test_events_stock_split_calendar',
                'test_events_dividend_calendar'
            ],
            'Institutional & Insider Data': [
                'test_institutional_13f',
                'test_institutional_holders',
                'test_institutional_insider_trading'
            ],
            'Economic Data': [
                'test_economy_gdp',
            ...
            'ETF & Mutual Funds': [
                'test_etf_list',
                'test_etf_holdings',
                'test_etf_performance',
                'test_mutual_funds_list'
            ],
            'Commodities': [
                'test_commodities_list',
                'test_commodities_metals',
                'test_commodities_energy',
                'test_commodities_historical'
            ],
            'Cryptocurrencies': [
                'test_crypto_list',
                'test_crypto_quote',
            ...
            'Bulk Data': [
                'test_bulk_eod_prices',
                'test_bulk_fundamentals',
                'test_bulk_insider_trading'
            ],
            'System Endpoints': [
                'test_health_check',
                'test_endpoints_list',
            ...
            'Error Handling': [
                'test_invalid_symbol_404',
                'test_invalid_endpoint_404',
                'test_missing_required_params_400'
            ],
            'Caching & Routing': [
                'test_cache_behavior',
                'test_polygon_provider_routing',
                'test_fmp_provider_routing'
            ]
        }
    ...
    def run_category_tests(self, category: str, test_methods: list):
        ...
        for test_method in test_methods:
            if test_method not in category_results['tests']:
                category_results['tests'][test_method] = {
                    'status': 'PASSED',
                    'error': None
                }
