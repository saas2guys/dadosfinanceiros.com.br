...
from .models import User, Plan, TokenHistory, WaitingList


@admin.register(WaitingList)
class WaitingListAdmin(admin.ModelAdmin):
    list_display = ['email', 'first_name', 'last_name', 'company', 'created_at', 'is_notified']
    ...
    fieldsets = (
        ...
        ('Status', {
            'fields': ('is_notified', 'notified_at', 'created_at')
        }),
    )
