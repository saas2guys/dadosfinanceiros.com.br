...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('email', 'password', 'password2', 'first_name', 'last_name', 'token_auto_renew', 'token_validity_days')
        extra_kwargs = {
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'email', 'first_name', 'last_name', 'token_info',
                 'daily_request_limit', 'daily_requests_made', 'last_request_date',
                 'token_auto_renew', 'token_validity_days')
