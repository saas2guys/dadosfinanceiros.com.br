...
class User(AbstractUser):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.request_token_created and not self.request_token_expires and not self.token_never_expires:
    ...
    def generate_new_request_token(self, save_old=True, never_expires=False):
        ...
        if save_old and self.request_token:
            ...
            old_tokens.append({
                'token': str(self.request_token),
                'created': self.request_token_created.isoformat() if self.request_token_created else None,
