...
class WaitingList(models.Model):
    ...
    desired_endpoints = models.JSONField(default=list, blank=True)
    desired_plan = models.CharField(max_length=100, blank=True)
    desired_billing_cycle = models.CharField(max_length=10, choices=[('monthly', 'Monthly'), ('yearly', 'Yearly')], blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
